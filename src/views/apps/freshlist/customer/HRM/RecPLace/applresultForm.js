...
// import { HRM_APPLIED } from '../../../../../../ApiEndPoint/Api';
...
//   // job,name,email,mobileNo,status
//   const handleSubmit = async (e) => {
//     e.preventDefault();
//     console.log(data)
//     await _PostSave(HRM_APPLIED, data).then((res) => {
//       console.log(res)
//     }).catch((err) => {
//       console.log(err)
//     })
...
//                   />
//                   <span style={{ marginRight: '30px', marginLeft: '25px', marginTop: '5px' }}>Active</span>
//                   <Input
//                     type="radio"
//                     name="status"
//                     value="Deactive"
