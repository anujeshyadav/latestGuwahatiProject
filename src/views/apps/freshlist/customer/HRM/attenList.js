...
import { _Delete, _GetList } from "../../../../../ApiEndPoint/ApiCalling";
import { HRM_VIEW_ATTENDANCE } from "../../../../../ApiEndPoint/Api";
...
class AttendList extends React.Component {
                    ...
                    cellRendererFramework: (params) => {
                        return (
                            <div className="d-flex align-items-center cursor-pointer">
                                <div>
                                    <span>{params.data?.employee}</span>
                                </div>
                            </div>
                        );
                    },
    ...
    async Apicalling(id, db) {
        ...
        await _GetList(HRM_VIEW_ATTENDANCE, id, db)
            .then((res) => {
                console.log(res)
                this.setState({ Loading: false });

                if (res?.Attendance) {
                    this.setState({ rowData: res?.Attendance });
                }
    ...
    runthisfunction(id) {
        swal("Warning", "Sure You Want to Delete it", {
            ...
            switch (value) {
                case "delete":
                    _Delete(HRM_DELETE_ATTENDANCE, id)
                        .then((res) => {
