...
import { HRM_DELETE_INDICATOR, HRM_VIEW_INDICATOR } from "../../../../../ApiEndPoint/Api";
...
class  IndicList extends React.Component {
                ...
                },
                {
                    ...
                    cellRendererFramework: (params) => {
                        return (
                            <div className="d-flex align-items-center cursor-pointer">
                                <div>
                                    <Badge color="primary">{params.data?.department}</Badge>
                                </div>
                            </div>
                        );
                    },
                ...
                },
                {
                    ...
                    cellRendererFramework: (params) => {
                        return (
                            <div className="d-flex align-items-center cursor-pointer">
                                <div>
                                    <span>{params.data?.collections}</span>
                                </div>
                            </div>
                        );
                    },
    ...
    async Apicalling(id, db) {
        ...
        await _GetList( HRM_VIEW_INDICATOR,id, db)
            .then((res) => {
                console.log(res)
