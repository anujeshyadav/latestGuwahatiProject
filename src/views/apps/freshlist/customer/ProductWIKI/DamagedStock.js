        ...
        },
        {
          ...
          cellRendererFramework: (params) => {
            return (
              <>
                <div className="actions cursor-pointer">
                  <Badge color="primary">{params?.data?.price}</Badge>
                </div>
              </>
            );
          },
        },
        {
          ...
          cellRendererFramework: (params) => {
            return (
              <>
                <div className="actions cursor-pointer">
                  <Badge color="primary">{params?.data?.reason}</Badge>
                </div>
              </>
            );
          },
        },
        {
          ...
          cellRendererFramework: (params) => {
            return (
              <>
                <div className="actions cursor-pointer">
                  <Badge color="danger">{params?.data?.transferQty}</Badge>
                </div>
              </>
            );
          },
