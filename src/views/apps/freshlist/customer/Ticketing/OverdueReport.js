      ...
      columnDefs: [
        ...
        },
        {
          ...
          cellRendererFramework: (params) => {
            return (
              <div>
                <span>{params?.data?.partyId?.Lock_in_time}</span>
              </div>
            );
          },
        },
        ...
        },
        {
          ...
          cellRendererFramework: (params) => {
            return (
              <div>
                <span>{params?.data?.partyId?.Pan_Num}</span>
              </div>
            );
          },
        },
