...
class SalesCompletedOrderReports extends React.Component {
  ...
  async Apicalling(id, db) {
    ...
    await SalesReturnProductList(id, db)
      .then((res) => {
        ...
        this.setState({ rowAllData: res?.SalesReturn });
        this.setState({ AllcolumnDefs: this.state.columnDefs });
        this.setState({ SelectedCols: this.state.columnDefs });

        let userHeading = JSON.parse(
          localStorage.getItem("SalesOrderReturnReport")
        );
  ...
  async componentDidMount() {
    ...
    const InsidePermissions = CheckPermission("Sales Return Report");
