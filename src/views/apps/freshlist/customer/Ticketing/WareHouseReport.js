...
class WareHouseReport extends React.Component {
      ...
      columnDefs: [
        ...
        },
        {
          ...
          cellRendererFramework: (params) => {
            return (
              <div>
                <span>{params?.data?.productId?.unitType}</span>
              </div>
            );
          },
        },
  ...
  handleChangeView = (data, types) => {
    let type = types;
    if (type == "readonly") {
      console.log("ResponseData", data.productItems);
