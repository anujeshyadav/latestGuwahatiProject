        ...
        },
        {
          ...
          cellRendererFramework: (params) => {
            return (
              <div className="d-flex align-items-center cursor-pointer">
                <div>
                  <Badge color="primary">{params.data?.orderId?.amount}</Badge>
                </div>
              </div>
            );
          },
        },
        {
          ...
          cellRendererFramework: (params) => {
            return (
              <div className="d-flex align-items-center cursor-pointer">
                <div>
                  <Badge color="primary">{params.data?.orderId?.roundOff}</Badge>
                </div>
              </div>
            );
          },
                  ...
                  <Row>
                      ...
                      <div className="">
                        ...
                        <strong>
                          {this.state.ViewOneData &&
                            `${this.state.ViewOneData?.partyId?.firstName} ${this.state.ViewOneData?.userId?.lastName}`}
                        </strong>
                      </div>
                      <div className="">
                        Mobile-{" "}
                        {this.state.ViewOneData &&
                          ` ${this.state.ViewOneData?.partyId?.Contact_Details}`}
                      </div>
                      <div className="">
                        Email -{" "}
                        {this.state.ViewOneData &&
                    ...
                    <Col>
                      ...
                      <h5>
                        <strong>
                          {this.state.ViewOneData &&
                            this.state.ViewOneData?.orderId?.amount}{" "}
                        </strong>
                        Rs/-
                      </h5>
                    </Col>
